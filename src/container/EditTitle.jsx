...
const EditTitle = () => {
    ...
    return (
        <div className='w-[1440px] min-h-[1024px] bg-[#F4F4F4] '>
            <div className='flex justify-between mx-[220px] mt-[43px]' >
                <div className='flex gap-3 items-center'>
                    <div data-cy="todo-back-button" className='w-[32px] h-[32px] cursor-pointer '>
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-left" width="32" height="32" viewBox="0 0 24 24" strokeWidth="4" stroke="#111111" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <polyline points="15 6 9 12 15 18"></polyline>
                        </svg>
                    </div>
                    <div data-cy="todo-title" className='min-w-[233px] h-[54px] font-poppins font-bold text-[36px] leading-[54px] text-[#111111] '>
                        <form>
                            <div className='flex items-center'>
                                <input
                                    ...
                                    className='w-[233px] h-[54px] border-b-2 border-black outline-none text-[36px] font-bold bg-transparent'
                                />
                                <div onClick={handlePost} data-cy="todo-title-edit-button" className='w-[24px] h-[24px] cursor-pointer'>
